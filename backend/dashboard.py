...
def get_dashboard_compare(cur):
    ...
    return {
        ...
        'box': {
            'lastDay': str(round(fake_list[-1], 2)),
            'lastMonth': "-",
            'lastYear': "-",
...
def get_dashboard_futurepast(data, cur):
    ...
    if(data['comp'] == "future"):
        ...
        d_date, d_month, d_year = "18", "12", "2021"
    ...
    # past
        ...
        return{
            "daily": {
                ...
                "graph": {
                    # "xAxis": ["30/11/21", "01/12/21", "02/12/21", "03/12/21", "04/12/21", "05/12/21", "06/12/21", "07/12/21", "08/12/21", "09/12/21", "10/12/21"],
                    "xAxis": ["08/12/21", "09/12/21", "10/12/21", "11/12/21", "12/12/21", "13/12/21", "14/12/21", "15/12/21", "16/12/21", "17/12/21", "18/12/21"],
                    "yAxis": fake_list
                }
            },
            "monthly": {
