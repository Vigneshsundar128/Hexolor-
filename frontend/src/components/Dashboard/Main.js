...
function Main({ efficiencyBox }) {
    ...
    const [batteryAPIVoltage, setBatteryAPIVoltage] = useState(3)
    const [batteryAPICurrent, setBatteryAPICurrent] = useState(100)
    ...
    const getVoltageCurrent = () => {
        axios.get("http://blynk-cloud.com/qVJoK80A5WjpWihghgRjyqop6pP-8giy/get/V1")
            .then(res => {
                setBatteryAPIVoltage(parseFloat(res.data));
            })
        axios.get("http://blynk-cloud.com/qVJoK80A5WjpWihghgRjyqop6pP-8giy/get/V2")
            .then(res => {
                setBatteryAPICurrent(parseFloat(res.data));
            })
        axios.get("http://blynk-cloud.com/qVJoK80A5WjpWihghgRjyqop6pP-8giy/get/V8")
            .then(res => {
                setPowerToday(res.data);
            })
    }
    ...
    return (
        <div style={{ display: 'flex' }}>
            <div style={{ width: "48%", height: "calc(100vh - 135px)", marginLeft: "20px" }}>
                <div className="dashboard__container" style={{ height: "50%", overflow: "hidden", marginBottom: "20px", position: "relative" }}>
                ...
                <div className="dashboard__container" style={{ height: "46.75%", overflow: "hidden", position: "relative" }}>
                    <div className="dashboard__container__title blue-p">
                        Battery Status
                    </div>
                    <div className='flex'>
                        ...
                        <div className="battery1__details__charge">
                            <div className="battery1__details__charge__background" style={{ height: (15 + (((100 - batteryHeight) / 100) * 181)) }}>
                            </div>
                            <div className="battery1__details__charge__background__inner">
                            </div>
                            <img src={BatteryImg} alt="battery" className="battery1__details__charge__image" />
                        </div>
                    </div>
                </div>
            </div>
            <div style={{ width: "48%", height: "calc(100vh - 135px)", marginLeft: "20px" }}>
                <div className="dashboard__container" style={{ height: "50%", overflow: "hidden", marginBottom: "20px", position: "relative" }}>
                    ...
                    <div className="flex">
                        ...
                        <div className="dashboard__container__box11" style={{ margin: "0", marginTop: "20px" }}>
                        ...
                        <div className="dashboard__container__box11" style={{ marginLeft: "20px", marginTop: "20px" }}>
                            <div className="dashboard__container__box__title11 blue-p">
                                Efficiency Variance
                            </div>
                            <div className="dashboard__container__box__value11 green-p">
